...
const SORT_OPTIONS = [
  ...
  { id: 'ratingLow', label: 'Rating: Low to High' },
  { id: 'distanceNear', label: 'Distance: Near to Far' },
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl z-[110] overflow-hidden flex flex-col max-h-[80vh] w-full max-w-md mx-auto pb-safe"
      >
        {/* Header */}
